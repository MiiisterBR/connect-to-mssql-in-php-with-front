...
<div class="w-full mx-auto mt-6 p-6 bg-white shadow-lg rounded-lg">
    ...
    <form id="queryForm" class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <div>
            ...
            <input type="text" name="table_name" id="table_name" list="tableList"
        ...
        <div>
            <label class="block text-sm font-medium text-gray-700">WHERE Clause</label>
        ...
        <button type="submit"
                class="col-span-1 md:col-span-3 bg-blue-500 text-white py-2 rounded-lg font-bold hover:bg-blue-600">Run
            Query
        </button>
    </form>
