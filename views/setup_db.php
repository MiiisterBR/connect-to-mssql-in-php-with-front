...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    setcookie('db_credentials', encryptData($db_credentials), time() + (10 * 365 * 24 * 60 * 60), '/');
...
<div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
    ...
    <form method="POST" class="space-y-4">
        ...
        <button id="logoutBtn" type="button"
                class="w-full bg-red-500 text-white py-2 px-4 rounded-lg font-bold hover:bg-red-600 mt-2">Logout
        </button>
    </form>
</div>
<script>
